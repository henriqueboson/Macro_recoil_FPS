...
SMGRecoilMouseMoveAmount    = 4  --           // distance the mousewill move down for recoil compensation NO decimals
ARRecoilMouseMoveAmount     = 8 --           // MORE == Pulls Mouse down more. 1 mousemove==100 DelaySleep
 
SMGMouseMoveDelaySleep      = 4  --           // Delay in miliseconds between each time RecoilMouseMoveAmount
ARMouseMoveDelaySleep       = 4  --           //  More==less mouse pull down, 1 mousemove==100 DelaySleep
...
ARRapidFireDelayBetweenShots    = 100 --     // between each time SMG/AR/RecoilMouseMoveAmount moves your mouse  
...
RapidFireMousePressDurationAR   = 1 --       //  in milliseconds. 1 == 1 tap
...
RapidFireButton = "capslock" --       https://i.imgur.com/WinEVPi.png list of logitech mouse keys. 
